    ...
    <footer className="bg-primary-dark text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Équipe</a></li>
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Carrières</a></li>
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Partenaires</a></li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-accent">Ressources</h3>
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Centre d'aide</a></li>
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Webinaires</a></li>
              <li><a href="#" className="text-gray-300 hover:text-accent transition-colors">Fiscalité au Cameroun</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>© 2025 DSFacile. Tous droits réservés.</p>
